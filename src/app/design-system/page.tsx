    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex justify-between items-start">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Design System</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardHeader>
              <CardTitle className="text-gray-900 dark:text-white">Farben</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Primary Colors */}
              <div>
                <h3 className="font-medium mb-3 text-gray-800 dark:text-gray-200">Primary Colors</h3>
                <div className="grid grid-cols-5 gap-2">
                  {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((shade) => (
                    <div key={shade} className="text-center">
                      ...
                      />
                      <div className="text-xs mt-1 text-gray-600 dark:text-gray-400">{shade}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Success Colors */}
              <div>
                <h3 className="font-medium mb-3 text-gray-800 dark:text-gray-200">Success Colors</h3>
                <div className="grid grid-cols-5 gap-2">
                  {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((shade) => (
                    <div key={shade} className="text-center">
                      <div 
              ...
              {/* Warning Colors */}
              <div>
                <h3 className="font-medium mb-3 text-gray-800 dark:text-gray-200">Warning Colors</h3>
                <div className="grid grid-cols-5 gap-2">
                  {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((shade) => (
                    <div key={shade} className="text-center">
                      <div 
              ...
              {/* Danger Colors */}
              <div>
                <h3 className="font-medium mb-3 text-gray-800 dark:text-gray-200">Danger Colors</h3>
                <div className="grid grid-cols-5 gap-2">
                  {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((shade) => (
                    <div key={shade} className="text-center">
                      <div 
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardHeader>
              <CardTitle className="text-gray-900 dark:text-white">Typografie</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white font-audiowide tracking-wider">DOIT</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400">App Title - Audiowide font</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-base text-gray-900 dark:text-gray-100">Body Text</p>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">text-sm</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Primary Buttons</h3>
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Secondary Buttons</h3>
                <div className="flex gap-2 flex-wrap">
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Ghost Buttons</h3>
                <div className="flex gap-2 flex-wrap">
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Icon Buttons</h3>
                <div className="flex gap-2 flex-wrap">
                  <Button size="sm"><Plus className="h-4 w-4 mr-2" />Mit Icon</Button>
                  <Button variant="outline"><Edit className="h-4 w-4 mr-2" />Bearbeiten</Button>
                  <Button variant="ghost"><Trash2 className="h-4 w-4 mr-2" />Löschen</Button>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="Deine E-Mail eingeben" />
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="message" className="text-gray-900 dark:text-gray-100">Nachricht</Label>
                <Textarea id="message" placeholder="Deine Nachricht hier..." />
              </div>

              <div className="space-y-3">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Checkboxes</h3>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="terms" className="text-gray-900 dark:text-gray-100">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="newsletter" className="text-gray-900 dark:text-gray-100">
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Default Badges</h3>
                <div className="flex gap-2 flex-wrap">
                  <Badge>Default</Badge>
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Status Badges</h3>
                <div className="flex gap-2 flex-wrap">
                  ...
                  <Badge className="bg-danger-100 text-danger-800 dark:bg-danger-900 dark:text-danger-200">
                    <AlertCircle className="h-3 w-3 mr-1" />Überfällig
                  </Badge>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardHeader>
              <CardTitle className="text-gray-900 dark:text-white">Dropdowns</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Actions Menu</h3>
                <DropdownMenu>
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Priority Menu</h3>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardHeader>
              <CardTitle className="text-gray-900 dark:text-white">Cards</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Basic Card</h3>
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Todo Card Example</h3>
                <Card className="p-4 bg-gradient-to-r from-primary-200/30 to-white dark:from-primary-900/20 dark:to-gray-800 border-l-4 border-l-primary-500">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">Meeting vorbereiten</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Heute, 14:00</p>
                    </div>
